...
#     # heatmap_avg=body_estimation(oriImg)
#     canvas = util.draw_bodypose(oriImg, candidate, subset)
#     # canvas = util.draw_bodypose(oriImg,heatmap_avg)
#     plt.imshow(canvas[:, :, [2, 1, 0]])
#     # plt.show()
#     # plt.pause(20)
#     save_path = 'output_image.jpg'  # Specify the path and filename for the saved image
...
# #     # Open the video file (MP4 format)
# #     # video_path = 'input-1.mp4'  # Change this to your MP4 file
# #     directory_path = 'D:\Fifth Semester\DSE Project\\frontEnd\server-backend\public\Images'
...
# #     # Iterate through the list of files
# #     for filename in file_list:
# #         # Print the filenames or perform other operations
# #         # print(filename)
# #         video_path=filename
# #         cap = cv2.VideoCapture(video_path)
